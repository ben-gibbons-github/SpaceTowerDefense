...
{
    public class ModelForm : ValueForm
    {
        ...
        public ModelForm(LinkedList<Value> ReferenceValues)
        ...
        {
            foreach (ModelValue val in ReferenceValues)
            {
        ...
        public override void GetValueFromField()
        {
            ...
            try
            {
                ...
                Value = AssetManager.LoadUnsafe<Model>(GameManager.GetLevel().MyScene.ModelDirectory.get() + Path);
